...
3. Easy to deploy, add the folder to the MATLAB path, then start.
...
In which
    ...
    $R_{I,s}$ = The probability of producing isomer $^{A+1,s}X$ after $^AX$ absorbs a neutron.
